    ...
    <>
      <div className="mb-4 flex justify-between mt-5">
        <div className="md:w-[300px]">
          <h2 className="text-3xl font-bold">Products Dashboard</h2>
        </div>
        <div className="md:w-[500px]">
          <input
            type="text"
            placeholder="enter search here"
            className="py-3 px-3 outline-0 border border-gray-300 rounded-lg w-full bg-gray-200"
          />
        </div>
        <div>
          <button className="py-2 px-4 bg-indigo-600 rounded-full text-white font-semibold">
            Download Report
          </button>
        </div>
      </div>
